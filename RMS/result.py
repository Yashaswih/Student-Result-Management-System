...
class resultClass:
    def __init__( self,root):
     ...
     #======title======
      title=Label(self.root,text="Add Student Results",font=("goudy old style",20,"bold"),bg="Orange",fg="#262626").place(x=10,y=15,relwidth=1,height=50)
    #==========widges=============
    #============variables========
      ...
      txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",20,"bold"),bg="lightgray",state='readonly').place(x=280,y=160,width=320)
      txt_course=Entry(self.root,textvariable=self.var_course,font=("goudy old style",20,"bold"),bg="lightgray",state='readonly').place(x=280,y=220,width=320)
      txt_marks=Entry(self.root,textvariable=self.var_marks,font=("goudy old style",20,"bold"),bg="lightgray").place(x=280,y=280,width=320)
      txt_full_marks=Entry(self.root,textvariable=self.var_full_marks,font=("goudy old style",20,"bold"),bg="lightgray").place(x=280,y=340,width=320)
      ...
      btn_clear=Button(self.root,text="Clear",font=("times new roman",15),bg="lightblue",activebackground="lightblue",cursor="hand2",command=self.clear).place(x=430,y=420,width=120,height=35)
    #=========================================================
    def fetch_roll(self):

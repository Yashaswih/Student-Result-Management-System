...
class studentClass:
    ...
    #==========Column 1======================
      ...
      txt_state=Entry(self.root,textvariable=self.var_state,font=("goudy old style",15,"bold"),bg="lightgray")
      ...
      txt_city=Entry(self.root,textvariable=self.var_city,font=("goudy old style",15,"bold"),bg="lightgray")
      ...
      txt_pin=Entry(self.root,textvariable=self.var_pin,font=("goudy old style",15,"bold"),bg="lightgray")
     ...
     #=========Entry Fields======
      self.txt_roll=Entry(self.root,textvariable=self.var_roll,font=("goudy old style",15,"bold"),bg="lightgray")
      self.txt_roll.place(x=150,y=60,width=200)
      txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",15,"bold"),bg="lightgray").place(x=150,y=100,width=200)
      txt_email=Entry(self.root,textvariable=self.var_email,font=("goudy old style",15,"bold"),bg="lightgray").place(x=150,y=140,width=200)
      ...
      self.fetch_course()
      txt_dob=Entry(self.root,textvariable=self.var_dob,font=("goudy old style",15,"bold"),bg="lightgray")
      txt_dob.place(x=480,y=60,width=200)
      txt_contact=Entry(self.root,textvariable=self.var_contact,font=("goudy old style",15,"bold"),bg="lightgray").place(x=480,y=100,width=200)
      txt_addmission=Entry(self.root,textvariable=self.var_a_date,font=("goudy old style",15,"bold"),bg="lightgray").place(x=480,y=140,width=200)
     ...
     #============Text Address======================
      ...
      self.txt_address=Text(self.root,font=("goudy old style",15,"bold"),bg="lightgray")
     ...
     #========search panel=======
      ...
      txt_search_roll=Entry(self.root,textvariable=self.var_search,font=("goudy old style",15,"bold"),bg="lightgray").place(x=870,y=60,width=180)
     ...
     #=======content=======
      ...
      self.CourseTable.column("addmission",width=150)

...
class reportClass:
    def __init__( self,root):
     ...
     #=======search========
      ...
      txt_search=Entry(self.root,textvariable=self.var_search,font=("goudy old style",20,),bg="lightgray").place(x=520,y=100,width=150)
      ...
      btn_clear=Button(self.root,text="Clear",font=("goudy old style",15,"bold"),bg="green",fg="white",cursor="hand2",command=self.clear).place(x=800,y=100,width=100,height=35)
